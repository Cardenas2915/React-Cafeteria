...
export default function Ordenes() {
  ...
  const {handleClickCcompletarPedido} = useQuiosco();
          ...
          <div key={pedido.id} className="p-5 bg-white shadow space-y-2 border-b">
...

            {
              pedido.productos.map(producto => (
                <div className="border-b border-b-slate-200 last-of-type:border-none py-4" key={producto.id}>
            ...
            <button
              type="submit"
              onClick={() => handleClickCcompletarPedido(pedido.id)}
